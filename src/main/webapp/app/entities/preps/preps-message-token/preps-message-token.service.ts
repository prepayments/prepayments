...
export class PrepsMessageTokenService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/preps-message-tokens';
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IPrepsMessageToken[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
