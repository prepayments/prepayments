...
export class PrepsFileTypeService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/preps-file-types';
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IPrepsFileType[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
